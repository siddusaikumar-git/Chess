...
class SelectPieces:
    ...
    def king_pos_check(self, new_x, new_y, opposite_team):

        if (self.boardBoundary[0] <= new_x <= self.boardBoundary[1] and
                self.boardBoundary[0] <= new_y <= self.boardBoundary[1]):
            if self.board[new_x][new_y] == "." or self.board[new_x][new_y][0] == opposite_team:
                return True
        return False
    ...
    def king_select(self, x_pos, y_pos, opposite_team):

        if len(self.board[x_pos][y_pos]) != 2 or self.board[x_pos][y_pos][1] != "k":
            return [None]
        ...
        for p_x, p_y in self.kingRange:
            ...
            if self.king_pos_check(new_x, new_y, opposite_team):
                possible_king_positions.append((new_x, new_y))

        return possible_king_positions

    def pos_check(self, x_pos, y_pos, opposite_team, direction):
        possible_queen_pos = []
        for new_pos in range(1, self.queenRange):
            ...
            if (self.boardBoundary[0] <= new_x <= self.boardBoundary[1] and
                ...
                elif self.board[new_x][new_y][0] == opposite_team:
                    possible_queen_pos.append((new_x, new_y))
                    break
                else:
                    break
    ...
    def queen_select(self, x_pos, y_pos, opposite_team):

        if len(self.board[x_pos][y_pos]) != 2 or self.board[x_pos][y_pos][1] != "q":
            return [None]
        ...
        for direction in self.queen_directions:
            possible_queen_positions.extend(self.pos_check(x_pos, y_pos, opposite_team, direction))
    ...
    def bishop_select(self, x_pos, y_pos, opposite_team):

        if len(self.board[x_pos][y_pos]) != 3 or self.board[x_pos][y_pos][1] != "b":
            return [None]
        ...
        for direction in bishop_directions:
            possible_bishop_positions.extend(self.pos_check(x_pos, y_pos, opposite_team, direction))
    ...
    def rook_select(self, x_pos, y_pos, opposite_team):

        if len(self.board[x_pos][y_pos]) != 3 or self.board[x_pos][y_pos][1] != "r":
            return [None]
        ...
        for direction in rook_directions:
            possible_rook_positions.extend(self.pos_check(x_pos, y_pos, opposite_team, direction))
    ...
    def pawn_pos_check(self, x_pos, y_pos, opposite_team):
        ...
        for direction in directions:
            ...
            if (self.boardBoundary[0] <= new_x <= self.boardBoundary[1] and
                ...
                if direction in {"top", "bottom"}:
                    ...
                    if self.board[new_x][new_y][0] == opposite_team:
                        possible_pawn_pos.append((new_x, new_y))
    ...
    def pawn_two_step_check(self, x_pos, y_pos, opposite_team):

        if ((opposite_team == "b" and self.board[x_pos - 1][y_pos] == "." and self.board[x_pos - 2][y_pos] == ".") or
                (opposite_team == "w" and self.board[x_pos + 1][y_pos] == "." and self.board[x_pos + 2][y_pos] == ".")):
            return True
        return False
    ...
    def pawn_select(self, x_pos, y_pos, opposite_team):

        if len(self.board[x_pos][y_pos]) != 3 or self.board[x_pos][y_pos][1] != "p":
            return [None]

        possible_pawn_positions = []

        if x_pos == 6 and self.pawn_two_step_check(x_pos, y_pos, opposite_team):
            possible_pawn_positions.append((x_pos - 2, y_pos))

        if x_pos == 1 and self.pawn_two_step_check(x_pos, y_pos, opposite_team):
            possible_pawn_positions.append((x_pos + 2, y_pos))

        possible_pawn_positions.extend(self.pawn_pos_check(x_pos, y_pos, opposite_team))
    ...
    def knight_select(self, x_pos, y_pos, opposite_team):

        if len(self.board[x_pos][y_pos]) != 3 or self.board[x_pos][y_pos][1] != "k":
            return [None]
